...
| Liveness / eligibility check | **testnet** | World ID Selfie Check via IDKit against the World ID Sandbox app. Gates mandate signing, facility approval and subscription |
